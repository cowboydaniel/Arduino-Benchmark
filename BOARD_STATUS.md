...
| Arduino Uno R4 Minima | Core: /IDE: 2.3.7 | 1.0.0 | passed | reports/unor4minima-x.x.x.txt |
...
| Arduino Nano Matter | - | - | - | - |
| Arduino Mega 2560 | - | - | - | - |
| Arduino Mega 2560 Rev3 | Core: /IDE: 2.3.7 | 1.0.0 | passed | reports/mega2560r3-x.x.x.txt |
| Arduino Mega ADK | - | - | - | - |
